...
MODULE MyNumbers
  ...
  INTEGER, PARAMETER :: RQKIND = SELECTED_REAL_KIND (30, 300)
  INTEGER, PARAMETER :: CKIND = RKIND 
  INTEGER(IKIND), PARAMETER :: INElements=110
  INTEGER(IKIND), PARAMETER :: ITHREE=3_IKIND
  
  REAL(RKIND) :: PI,TWOPI,ONEPLS,ONEMNS,SQRTHALF,SQRTTWO,DEG2RADIAN,TWODEG2RADIAN,RADIAN2DEG
  ...
  REAL(RKIND) :: TINY= 1.0E-9_RKIND,NEGHUGE=-1.0E9_RKIND
